...
router.post('/users-signup', users_controller_1.uploadPhotos, users_controller_1.userSignUp);
...
router.get('/users-list', users_controller_1.isAuthorize, chat_controller_1.getUserChats);
